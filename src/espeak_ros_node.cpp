...
int main( int argc, char** argv ) {
    ...
    if (priv_n.getParam("voice", voice_name) == false) {
    	priv_n.setParam("voice", voice_name);
    }
    if (priv_n.getParam("dialect", dialect) == false) {
    	priv_n.setParam("dialect", dialect);
    }
